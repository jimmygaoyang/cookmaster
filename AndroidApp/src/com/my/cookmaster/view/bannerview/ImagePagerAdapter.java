 ...
 */
package com.my.cookmaster.view.bannerview;
...
public class ImagePagerAdapter extends BaseAdapter {
	...
	public ImagePagerAdapter(Context context, List<String> imageIdList,
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageForEmptyUri(R.drawable.meinv) 
				.showImageOnFail(R.drawable.meinv) 
				.cacheInMemory(true) 
				.cacheOnDisc(true) 
				.build();
...
//				Toast.makeText(context, "点击了" + getPosition(position) + "美女图",
//						0).show();
