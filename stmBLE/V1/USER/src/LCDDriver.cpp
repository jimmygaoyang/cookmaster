...
{
	if(rs == 1)
		g_IOSet->m_OUT_LCD_RS->SetDigitalOut(1);//Êý¾ÝÃüÁî
	else
		g_IOSet->m_OUT_LCD_RS->SetDigitalOut(0);//¿ØÖÆÃüÁî
	...
	g_IOSet->m_OUT_LCD_EN->SetDigitalOut(1);
	g_IOSet->m_OUT_LCD_EN->SetDigitalOut(0);
